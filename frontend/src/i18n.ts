    ...
    resources: {
      es: {
        translation: {
          ...
          hero: {
            titlePart1: "Construimos las ",
            titleItalic: "aplicaciones",
            titlePart2: " que la gente no sabía que necesitaba.",
      ...
      en: {
        translation: {
          ...
          hero: {
            titlePart1: "We build the ",
            titleItalic: "apps",
            titlePart2: " people didn't know they needed.",
